...
export const metadata: Metadata = {
  ...
  keywords: 'wellness AI, health optimization, fitness tracking, personalized wellness, AI health coach, wellness platform, health goals, fitness app',
  openGraph: {
  ...
  alternates: {
    canonical: 'https://wellnessai.com',
  },
};
